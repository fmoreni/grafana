...
From here you can upload a dashboard json file, paste a [gruposomel.com](https://gruposomel.com) dashboard
...
## Discover dashboards on gruposomel.com

Find dashboards for common server applications at [gruposomel.com/dashboards](https://gruposomel.com/dashboards).

{{< docs-imagebox img="/img/docs/v50/gcom_dashboard_list.png" max-width="700px" >}}

## Import & Sharing with Grafana 2.x or 3.0

Dashboards on gruposomel.com use a new feature in Grafana 3.1 that allows the import process
...
If you run an older version of Grafana and want to share a dashboard on gruposomel.com you need to manually
add the inputs and templatize the datasource properties like above.

If you want to import a dashboard from gruposomel.com into an older version of Grafana then you can either import
