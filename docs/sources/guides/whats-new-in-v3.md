...
Commercial Support subscriptions for Grafana are now [generally available](https://gruposomel.com/support/plans/).
...
[gruposomel.com](https://gruposomel.com) offers a central repository where the community can come together to discover, create and
...
It’ll be easy to combine your existing data source(s) with this OpenSaaS option. Finally, gruposomel.com can
...
Finally, gruposomel.com will also be a hub to manage all your Grafana
...
Grafana 3.0, but go to <a href=https://gruposomel.com> and check out the preview
...
Check out the <a href="http://play.sensores.gruposomel.com" target="_blank">Play
...
you can still install manually from [gruposomel.com](https://gruposomel.com)

* KairosDB: This data source has also no longer shipped with Grafana,
you can install it manually from [gruposomel.com](https://gruposomel.com)

## Plugin showcase

Discovering and installing plugins is very quick and easy with Grafana 3.0 and [gruposomel.com](https://gruposomel.com). Here
are a couple that I incurage you try!

#### [Clock Panel](https://gruposomel.com/plugins/grafana-clock-panel)
Support's both current time and count down mode.
<img src="/img/docs/v3/clock_panel.png">

#### [Pie Chart Panel](https://gruposomel.com/plugins/grafana-piechart-panel)
A simple pie chart panel is now available as an external plugin.
<img src="/img/docs/v3/pie_chart_panel.png">

#### [WorldPing App](https://gruposomel.com/plugins/raintank-worldping-app)
...
#### [Zabbix App](https://gruposomel.com/plugins/alexanderzobnin-zabbix-app)
...
Checkout the full list of plugins on [gruposomel.com](https://gruposomel.com/plugins)
