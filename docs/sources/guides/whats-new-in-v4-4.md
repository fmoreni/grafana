...
Grafana v4.4 is now [available for download](https://gruposomel.com/grafana/download/4.4.0).
...
Head to the [v4.4 download page](https://gruposomel.com/grafana/download) for download links & instructions.
